...
def main():
    ...
    rospy.init_node("ur5_NPK_Test", anonymous=True)
    ...
    try:
        while not rospy.is_shutdown():
            ...
            rospy.loginfo("Above Plant, watering")
            ...
            rospy.loginfo("Moving to Soil measurement area")
            ...
            rospy.loginfo("Soil is adequately fertillised")
